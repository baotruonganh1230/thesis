create table account (eid bigint not null, roleid bigint not null, enabled bit, locked bit, password varchar(255), username varchar(255), primary key (eid, roleid)) engine=InnoDB;
create table apply (jrecruitid bigint not null, cid bigint not null, primary key (jrecruitid, cid)) engine=InnoDB;
create table attendance (eid bigint not null, day date, time_in time, time_out time, primary key (eid)) engine=InnoDB;
...
create table department (id bigint not null auto_increment, location varchar(255), name varchar(255), primary key (id)) engine=InnoDB;
create table employee (id bigint not null auto_increment, bonus decimal(16,2), date_of_birth date, email varchar(255), employed_date date, first_name varchar(255), gross_salary decimal(16,2), last_name varchar(255), permanent_address varchar(255), phone varchar(255), sex varchar(255), temporary_address varchar(255), primary key (id)) engine=InnoDB;
...
create table job_recruitment (id bigint not null auto_increment, from_date date, job_description varchar(255), to_date date, primary key (id)) engine=InnoDB;
...
create table payment (eid bigint not null, derived_salary decimal(16,2), mandatory_insurance decimal(16,2), other_income decimal(16,2), payment_date date, personal_tax decimal(16,2), primary key (eid)) engine=InnoDB;
...
create table position (id bigint not null auto_increment, max_salary decimal(16,2), min_salary decimal(16,2), name varchar(255), primary key (id)) engine=InnoDB;
