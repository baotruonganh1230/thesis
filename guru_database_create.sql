...
create table payment (id bigint not null auto_increment, actual_day varchar(255), allowance_not_subjected_to_tax decimal(16,2), basic_salary decimal(16,2), dependent_relief decimal(16,2), lunch decimal(16,2), paid_leave varchar(255), parking decimal(16,2), payment_date date, personal_relief decimal(16,2), standard_day varchar(255), unpaid_leave varchar(255), eid bigint, payroll_id bigint, primary key (id)) engine=InnoDB;
